...
class ConsumptionAverageModel:
    """
    Consumption data has annual and monthly data, so it is processed according to annual or monthly data.
    """
    def __init__(self):
        print('******************** CONSUM AVG Model ********************')
    ...
    def calculate_ma(self, train):
        """
        The moving average model method to be used with the 'monthly' consumption dataset coming in
    ...
    def calculate_ols(self, train):
        """
        The least squares model method to be used with the 'monthly' consumption dataset coming in
