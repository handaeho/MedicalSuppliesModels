...
from patient_trend_model.trend_model_arma import PatientTrendARMAModel
...
class PatientTrendRunARMA:
    def __init__(self):
        print('******************** RUN TREND ARMA ********************')

        # 클래스 인스턴스
        self.arma = PatientTrendARMAModel()
        self.evalu = Evaluation()

    def run_arma_all_loc_hosp(self, userselect):
        """
        ...
        for i in diagcode_list:
            ...
            result_list.append(['ARMA', i, true_m, forecast, rmsle_m, mae_m])
    ...
    def run_arma_all_loc_div(self, userselect):
        """
    ...
    def run_arma_hosp(self, userselect):
        """
    ...
    def run_arma_div(self, userselect):
        """
...
if __name__ == '__main__':
    t = PatientTrendRunARMA()

    r1 = t.run_arma_all_loc_hosp([["J00"], "('외래', '입원')", 2020])
    r2 = t.run_arma_hosp([["J00"], "('입원')", "강원도", 2020])
    r3 = t.run_arma_all_loc_div([["J00", "A04.9-01"], "('외래', '입원')", 2020])
    r4 = t.run_arma_div([["J00", "A04.9-01"], "('외래', '입원')", "강원도", 2020])
